 ...
 *  1. 숫자형
 *  
 *  정수형 : byte, short, int, long (정수는 주로 int 사용)
 *  
 *  - byte 변수명;  // -128 ~ 127
 ...
 *  
 *  실수형 : float, double (실수는 주로 double 사용)
 *  
...
public class MainClass01 {
	public static void main(String[] args) {
		...
		long iLong=10;
		/*
		 *  int type 변수에 byte type 변수에 담긴 내용을 대입하려면?
		...
		float num1=10.1f;
		double num2=10.2d;
		double num3=10.3; // d, f를 붙이지 않으면 double type으로 간주 할 수도 있다.
