...
import java.util.ArrayList; //자바에서 제공하는  Util 클래스 import

/*
 * 	java에서 배열은 크기를 조정할 수 없는 고정배열이다
...
public class MainClass01 {
	public static void main(String[] args) {
		//String type 을 저장할 수 있는 ArrayList 객체생성해서 참조값을 names에 담아보세요
		//ArrayList <Class type> 참조데이터 타입만 담을 수 있다.
		//.add() , .get(), .size() 주로 사용 
